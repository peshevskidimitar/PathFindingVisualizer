...
// copied from https://github.com/BlueRaja/High-Speed-Priority-Queue-for-C-Sharp since this .net version dosent have a priority queue
// in standard System.Collections
namespace Priority_Queue
{
    ...
    public class SimplePriorityQueue<TItem, TPriority> : IPriorityQueue<TItem, TPriority>
    {
        ...
        public List<TItem> GetItems() { return _queue.GetItems().ToList().Select(x => x.Data).ToList(); }
